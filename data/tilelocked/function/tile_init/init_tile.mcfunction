execute if score #debug TileLockedData matches 1 run tellraw @a ["",{"text":"[TileLocked DEBUG] init_tile starting for ","color":"aqua"},{"selector":"@a[tag=currentPlayer,limit=1]"}]
