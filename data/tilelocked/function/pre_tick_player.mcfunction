...
# loaded, so without this check the player gets teleported straight into unloaded terrain (falls through
# an empty/black area until that distant chunk eventually loads, if ever, since it's outside their view
# distance and nothing forces it to load).
